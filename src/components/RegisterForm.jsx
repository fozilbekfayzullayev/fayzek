    ...
    <div className="container max-w-md mx-auto p-4 relative h-full shadow-lg md:shadow-none rounded-lg">
      ...
      <div className="px-8 pt-6 pb-8 mb-4 mt-12">
        ...
        <button
          ...
          className="w-full bg-black cursor-pointer text-white px-4 py-1 text-sm rounded font-medium hover:bg-stone-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
          Ro'yxatdan o'tish
        </button>
